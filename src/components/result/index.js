...
const Result = ({user}) => {
    ...
    return (
        <div className="content bg-[#F6F6F6] rounded ">
            ...
            <div className="p-3 space-x-4 flex items-center justify-between mb-3">
                ...
                <div className="flex-1 space-y-2">
                    ...
                    <p className="text-sm text-[#6F6F6F]">@evar_2022</p>
                </div>
            ...
            <div className="p-3 flex items-center justify-center flex-col">
                ...
                {/****Rep/Followers block**/}
                <div className="bg-[#FDFDFD] flex  items-center justify-center p-3 space-x-3
                rounded min-w-min	">
                    {/****Rep block**/}
                ...
                <div className="mt-5 p-3  flex items-start justify-between flex-wrap max-w-full mx-auto w-[400px]">
                    ...
                    <div className="sosial-info ">
                        ...
                        <span className="text-sm">test.com</span>
                    </div>
                </div>
